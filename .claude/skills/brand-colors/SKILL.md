---
name: brand-colors
description: Project brand color palette and gradient tokens. Reference this skill whenever choosing colors for UI components, buttons, accents, links, or themed elements.
...
## Secondary Palette (from glassmorphism design system)
